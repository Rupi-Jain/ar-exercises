...
# `@mens_stores`.
# 3. Loop through each of these stores and output their name and annual
#  revenue on each line.
# 4. Do another fetch but this time load stores that carry women's apparel 
...
@women_store = Store.where('womens_apparel = ? AND annual_revenue < ?', true, 1000000)
